...
###########################################################################
#  
#  Script ExtractMaskMUNet2_SBI.py
#  Desc:
...
for videoPath in nameList:
    ...
    folderData = sorted(glob.glob("./data/testData/SBI2015/dataset/" + videoPath + "/*.png"))
    folderBgSub = sorted(glob.glob("./data/testData/SBI2015/bgSub/" + videoPath + "/*.png"))
    folderFlux = sorted(glob.glob("./data/testData/SBI2015/flux/" + videoPath + "/*.png"))
    ...
    # set mask path
    maskDir = os.path.join('./outputMaskMUNet2/SBI2015/', videoPath)
