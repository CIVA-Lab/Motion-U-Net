###########################################################################
#
#  Program Name: Train Motion U-Net 1 (MU-Net1)
#                
#################################################################
#                
...
###########################################################################
#  
#  Script TrainMUNet1.py
#  Desc:
#        Main script used to train and save MU-Net1 model
#
#  Inputs:
#       Put your inputs and labels inside data/trainData/ folder
#       change extensions accordingly while loading the paths 
#             
#  Outputs: Trained model of MU-Net1
#        
###########################################################################
...
from pythonCodes.trainDataLoader import MU_Net1_DataLoader
...
dataset = MU_Net1_DataLoader(folderData, folderMask)
print(len(dataset))
...
torch.save(model, './models/MUNet1.pt') 
